...
# FlowForge
FlowForge is an experimental utility built for analysing and classifing packets by looking at packet headers. 
...
Additionally, Deepfence FlowForge also categorizes packets into flows and shows a rich ensemble of flow data and statistics.
...
Use FlowForge if you wish to build and operate machine-learning models on network packet data.



## Who uses FlowForge?

 * We use FlowForge internally to quickly analyse and label packets. It forms one part of a project to build a fast pre-filter for packets before we conduct deeper layer-7 analysis in [Deepfence ThreatMapper](https://deepfence.io/threatmapper/).
